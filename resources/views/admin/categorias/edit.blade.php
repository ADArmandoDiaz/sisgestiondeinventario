...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 15pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar de categoría</li>
        </ol>
    </nav>
    <hr>
@stop
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{ $categoria->nombre }}" class="form-control"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                        placeholder="Ingrese la descripción de la categoría">{{ $categoria->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
