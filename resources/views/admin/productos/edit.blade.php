...
@section('content_header')
    ...
    <nav aria-label="breadcrumb" style="font-size: 15pt">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar de producto</li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number"
                                                    ...
                                                    class="form-control" id="precio_compra" name="precio_compra" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number"
                                                    ...
                                                    class="form-control" id="precio_venta" name="precio_venta" required>
                                    ...
                                    {{-- Campo CORREGIDO: Stock Actual (Asegurando la precarga del valor existente) --}}
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="stock_actual">Stock actual <b style="color: red">(*)</b></label>
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-cubes"></i></span>
                                                </div>
                                                {{-- SE CORRIGE la precarga del valor: se usa old() o $producto->stock_actual --}}
                                                <input style="text-align: center" type="number" min="0"
                                                    value="{{ old('stock_actual', $producto->stock_actual ?? '') }}"
                                                    class="form-control" id="stock_actual" name="stock_actual" required>
                                            </div>
                                            @error('stock_actual')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number"
                                                    ...
                                                    class="form-control" id="stock_minimo" name="stock_minimo" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number"
                                                    ...
                                                    class="form-control" id="stock_maximo" name="stock_maximo" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="unidad_medida">Unidad medida <b style="color: red">(*)</b></label>
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <select name="unidad_medida" id="unidad_medida" class="form-control">
                                                    ...
                                                    <option value="unidad"
                                                        {{ $producto->unidad_medida == 'unidad' ? 'selected' : '' }}>Unidad

                                                    </option>

                                                    <option value="kg"
                                                        {{ $producto->unidad_medida == 'kg' ? 'selected' : '' }}>

                                                        Kilogramo(Kg)</option>

                                                    <option value="lt"
                                                        {{ $producto->unidad_medida == 'lt' ? 'selected' : '' }}>Litro (Lt)

                                                    </option>

                                                    <option value="gr"
                                                        {{ $producto->unidad_medida == 'gr' ? 'selected' : '' }}>Gramo (Gr)

                                                    </option>

                                                    <option value="m"
                                                        {{ $producto->unidad_medida == 'm' ? 'selected' : '' }}>Metro (M)

                                                    </option>

                                                    <option value="ml"
                                                        {{ $producto->unidad_medida == 'ml' ? 'selected' : '' }}>Mililitro
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="description">Descripción <b style="color: red">(*)</b></label>





                                            {{-- <span class="input-group-text"><i class="fas fa-align-log"></i></span> --}}

                                            <div class="editor-wrapper">

                                                <textarea id="description" name="description">{{ $producto->description }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="imagen">Imagen del producto <b
