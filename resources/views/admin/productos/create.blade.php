                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number" step="0.01"
                                                    min="0" value="{{ old('precio_compra') }}" class="form-control"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number" step="0.01"
                                                    min="0" value="{{ old('precio_venta') }}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input style="text-align: center" type="number" min="0"
                                                    value="{{ old('stock_actual') }}" class="form-control"
                                                    id="stock_actual" name="stock_actual" required>
                                            </div>
                                            @error('stock_actual')
                                                <small style="color: red">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <select name="unidad_medida" id="unidad_medida" class="form-control">
                                                    ...
                                                    <option value="kg"
                                                        {{ old('unidad_medida') == 'kg' ? 'selected' : '' }}>Kilogramo(Kg)
                                                    </option>
                                                    <option value="lt"
                                                        {{ old('unidad_medida') == 'lt' ? 'selected' : '' }}>Litro (Lt)
                                                    </option>
                                                    <option value="m"
                                                        {{ old('unidad_medida') == 'm' ? 'selected' : '' }}>Metro (M)
                                                    </option>
                                                </select>
                                            </div>
                                            @error('unidad_medida')
...
@section('css')
    ...
    <style>
        /* Estilos CSS originales y mejorados */
        #imgPreview {
            display: block;
            /* Asegura que la imagen de previsualización ocupe su propio espacio */
            border: 1px solid #ccc;
            /* Añade un borde para destacar la zona de la imagen */
            object-fit: contain;
            /* Asegura que la imagen se vea completa dentro de su área */
        }
        ...
        .ck-editor__editable {
            width: 100% !important;
            min-height: 200px;
            /* Reducido ligeramente para optimizar espacio */
        ...
        @media (max-width: 768px) {
            ...
            /* Asegura que el layout se colapse correctamente en móviles */
            .col-md-9,
            .col-md-3 {
                width: 100%;
                margin-bottom: 15px;
    ...
    <script>
        ...
        function previewImage(event) {
            ...
            reader.onload = function() {
                ...
                output.src = dataURL;
                output.style.display = 'block'; // Asegura que se muestre una vez cargada
            };
