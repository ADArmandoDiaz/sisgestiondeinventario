...
[
    ...
    'icon' => 'fas fa-fw fa-history',
       ...
       [
        ...
        'text' => 'Productos',
        'url' => 'admin/productos',
        'icon' => 'fas fa-fw fa-box-open', // <-- ¡Icono Sugerido!
    ...
    'icon' => 'fas fa-fw fa-exchange-alt', // icono más acorde a movimientos
...
[
    'text' => 'Lotes',
    'url'  => 'admin/lotes',
    'icon' => 'fas fa-fw fa-layer-group', // icono de lotes/capas
    'active' => ['admin/lotes*']
],
